...
import com.microservice.shoppingservice.service.InvoiceService;
...
public class InvoiceRest {
    ...
    @GetMapping
    public ResponseEntity<List<Invoice>> listAllInovices() {
    ...
    public ResponseEntity<Invoice> getInvoice(@PathVariable("id") Long id){
        log.info("Fetching Inovice with id {}", id);
    ...
    public ResponseEntity<Invoice> deleteInvoice(@PathVariable("id") Long id){
        log.info("Fetching & Deleting Inovice with id {}", id);
